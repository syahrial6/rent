        ...
        {cars.map((car) => (
          ...
          >
            ...
            <div className="px-6 py-4">
              ...
              <Link
                href={car.path}
                className="inline-block mt-4 bg-black hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
              >
                Isi Form
              </Link>
            </div>
